...
float consigne;
  ...
  if(bUpdateFlagsRC)
  {
    ...
    if(bUpdateFlagsRC & UP_DOWN_FLAG)
    {
      ...
      {
        consigne = (UpDownIn-1500)/700.0;
        Speed_Need += RC_CAR_SPEED * consigne;

        Speed_Need = constrain(Speed_Need, -800, 800);
    ...
    if(bUpdateFlagsRC & LEFT_RIGHT_FLAG)
    {
      ...
      consigne = (LeftRightIn-1500)/700.0;
      Turn_Need = -RCTurnSpeed *consigne;
      /*
        if(LeftRightIn > 1500)
